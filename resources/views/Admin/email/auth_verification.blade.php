                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    ...
                                                                    <div style="max-width: 147.333px;"><img
                                                                            alt="Company Logo" height="auto"
                                                                            src="{{ asset('email/unioil.png') }}"
                                                                            style="display: block; height: auto; border: 0; width: 100%;"
                                                                            title="Company Logo" width="147.333" />
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td class="pad" style="width:100%;">
                                                                <div align="center" class="alignment"
                                                                    ...
                                                                    <div style="max-width: 680px;"><img
                                                                            alt="Top round corners" height="auto"
                                                                            src="{{ asset('email/round_corner_top.png') }}"
                                                                            style="display: block; height: auto; border: 0; width: 100%;"
                                                            ...
                                                            <td class="pad">
                                                                <div align="center" class="alignment"
                                                                    ...
                                                                    <div class="fullWidth" style="max-width: 374px;">
                                                                        <img alt="Resetting Password" height="auto"
                                                                            src="{{ asset('email/password_reset.png') }}"
                                                                            style="display: block; height: auto; border: 0; width: 100%;"
                                                        ...
                                                        <tr>
                                                            <td class="pad" style="text-align:center;width:100%;">
                                                                <h1
                                                                    ...
                                                                    <strong>Your Verification Code</strong></h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <td class="column column-2"
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; word-break: break-word;">This
                                                                        code will authenticate your login in the raffle
                                                                        draw management system please do not share this
                                                                        code and delete this email afterwards</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table border="0" cellpadding="10" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <h1
                                                                    style="margin: 0; color: #000000; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 28px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 33.6px;">
                                                        ...
                                                        <tr>
                                                            <td class="pad" style="width:100%;">
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px">
                                                                    <div style="max-width: 680px;"><img
                                                                            alt="Bottom round corners" height="auto"
                                                                            src="{{ asset('email/round_corner_bottom.png') }}"
                                                                            style="display: block; height: auto; border: 0; width: 100%;"
