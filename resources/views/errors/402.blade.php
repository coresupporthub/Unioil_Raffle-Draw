...
<head>
	<title>Entry Codes Invalid</title>
	<meta charset="UTF-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
	<meta content="500 Error Page" name="description">
    ...
    <style>
		...
		.back-btn-500{
			...
			border-radius: 500px;
			background: #f66b04;
			background: -moz-linear-gradient(left, rgba(246,107,4,1) 0%, rgba(244,184,53,1) 100%); /* FF3.6-15 */
			background: -webkit-linear-gradient(left, rgba(246,107,4,1) 0%,rgba(244,184,53,1) 100%); /* Chrome10-25,Safari5.1-6 */
			background: linear-gradient(to right, rgba(246,107,4,1) 0%,rgba(244,184,53,1) 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
		...
		<section class="pd-5vw">
			<div class="text-red">
				...
				<h1 class="text-size-5-vh dpd-20 qlariti-line-height-0">
					Entry codes are either used or not valid
				</h1>
			</div>
